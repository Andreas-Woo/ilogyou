...
return [
    ...
    */
    ...
    'passwords' => [
        ...
        //business User password broker
        'businessUser' => [
            //user provider for business_users
            'provider' => 'business_users',
            //table to store password reset tokens for business_users
            'table' => 'business_user_password_resets',
